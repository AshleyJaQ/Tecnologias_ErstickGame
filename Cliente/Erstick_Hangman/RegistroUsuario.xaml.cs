...
namespace Erstick_Hangman
{
    ...
    public partial class RegistroUsuario : Window
    {
        ...
        private void Button_Registrarse(object sender, RoutedEventArgs e)
        {
            ...
            ServicioErstick2.Cuenta cuenta = new ServicioErstick2.Cuenta() { Correo = textBox_CorreoElectronico.Text, Contraseña = passwordBox_Contraseña.Password };
            ServicioErstick2.Jugador jugador = new ServicioErstick2.Jugador() { Apodo = textBox_Apodo.Text, Nombre = textBox_NombreUsuario.Text, Apellidos = textBox_Apellidos.Text };
            int respuesta;
            try
            {
        ...
        private Boolean ValidarCampos()
        {
            ...
            {
                string contraseñaInvalida = Properties.Resources.noCoincideContraseña;
